export const frontendDocsStoryLayoutClasses = {
  ...
  snippetCopyButton:
    'absolute bottom-0 right-0 inline-flex w-fit cursor-pointer items-center gap-1.5 border border-[var(--color-border-muted)] bg-[var(--color-bg-surface)] px-3 py-1.5 text-sm font-medium text-[var(--color-text-primary)]',
