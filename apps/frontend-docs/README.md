...
This workspace contains the docs and Storybook surfaces for frontend UI work.

Scope:
- `docs`: root documentation app implemented with Docusaurus.
...
- The Docusaurus docs app owns the shared explanation layer, package boundaries, and simplified visual contract samples.
...
- The final same-origin static host is assembled by the docs app, not by a composed Storybook hub.
...
- Keep docs as the root information architecture while Storybooks remain framework implementation workbenches.
